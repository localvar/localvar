+++
title = 'Build A Telegram Translation Bot With Easegress'
...
- filter: detectMessageType
   jumpIf:     result0: processText  # text
...
Now, we can test the bot in the chat. A demo video can be found at: [https://www.youtube.com/watch?v=ne0OvV1FmvA](https://www.youtube.com/watch?v=ne0OvV1FmvA).
